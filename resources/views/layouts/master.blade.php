...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      ...
      <a class="p-2 text-muted" href="{{ route('plats.index', ['categorie' => $category->slug]) }}"><strong>{{ $category->name }} ({{$category->nbr()}})</strong></a>
      @endforeach
    </nav>
  </div>
...
<footer class="blog-footer">
  ...
  <p>
    ...
    <a href="http://127.0.0.1:8000/" style="color:#0905f7" Align="Center">acceuil</a> -  L'ATLAS
  </p>
  <p>
    <a href="" style="color:#3a0efd">Revenir en haut</a>
  </p>
  </div>
</footer>
