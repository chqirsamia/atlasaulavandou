...
@section('content')
<div class="col-md-12">
    <a href="{{ route('cart.index') }}" class="btn btn-sm btn-secondary mt-3">Revenir à ma commande</a>
    <div class="row">
        <div class="col-md-6 mx-auto">
            ...
            <form action="{{ route('checkout.store') }}" method="POST" class="my-4" id="payment-form">
                ...
                <button class="btn btn-success btn-block mt-3" id="submit">
                    <i class="fa fa-credit-card" aria-hidden="true"></i> Payer maintenant ({{ getFrenshPrice(Cart::subtotal()) }})
                </button>
            </form>
        </div>
    </div>
